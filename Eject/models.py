...
class Profile(models.Model):
    ...
    def create_user_profile(sender, instance, created, **kwargs):
        ...
        post_save.connect(create_user-profile, sender=User)

    def save_profile(sef):
        self.save()
...
class Project(models.Model):
    ...
    @classmethod
    def find_project(cls,serach_term):
        project = Project.objects.all(title__icontains=serach_term)
        return project
...
class Reviews(models.Model):
    ...
    content = models.IntegerField(choices=RATING_CHOICES, default=True)
